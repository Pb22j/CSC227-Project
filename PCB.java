...
public class PCB {
    ...
    private int originalBrustTime; // Store original for calculations
    private int Priority;
    private int originalPriority; // Store original priority
    private int Size;
    public String state; // new, ready, running, wait, terminated
    private int turnaroundTime;
    private int waitingTime;
    private int readyQueueArrivalTime;  // When it entered ready queue
    private int degreeOfMultiprogramming; // # processes in queue when it arrived
    private int processesExecutedSinceArrival; // Counter for starvation
    private boolean hasStarved; // Flag for reporting
    private int completionTime; // When process finished
